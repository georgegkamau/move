...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post apartments_url, params: { apartment: { apt: @apartment.apt, city: @apartment.city, state: @apartment.state, street: @apartment.street, user_id: @apartment.user_id, zip_code: @apartment.zip_code } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { apt: @apartment.apt, city: @apartment.city, state: @apartment.state, street: @apartment.street, user_id: @apartment.user_id, zip_code: @apartment.zip_code } }
