...
class AppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apply" do
    assert_difference('Apply.count') do
      post applies_url, params: { apply: { apartment_id: @apply.apartment_id, message: @apply.message, user_id: @apply.user_id } }
    end
  ...
  test "should update apply" do
    patch apply_url(@apply), params: { apply: { apartment_id: @apply.apartment_id, message: @apply.message, user_id: @apply.user_id } }
